...
| `error` | `String \| Array` | `null` | Mensaje de error de validacion. Acepta array (formato Laravel 422) y toma el primer mensaje. Se oculta al elegir una opcion y reaparece cuando cambia |
